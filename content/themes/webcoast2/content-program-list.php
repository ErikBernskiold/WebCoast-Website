...
<li class="program-table-item">
	<ul>
		...
		<li class="program-table-item-info small-24 medium-17 large-14 columns">
			...
			<div class="program-table-item-excerpt"><span class="program-table-item-speaker"><?php if(get_field('program_talare')) : $speaker_counter = 1; while(the_repeater_field('program_talare')) : ?><?php if( $speaker_counter > 1 ) : ?>, <?php endif; ?><a href="<?php the_sub_field('program_talare_url'); ?>"><?php the_sub_field('program_talare_namn'); ?></a><?php $speaker_counter++; endwhile; endif; ?></span> - <?php echo webcoast_get_excerpt( 25 ); ?></div>
		</li>
